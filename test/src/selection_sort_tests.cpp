...
TEST_CASE("Checking Selection Sort Implementation", "[Selection Sort]")
{
    SECTION("0 Elements") {
        ...
        selection_sort(v0, cmp_fn_less);
        REQUIRE(std::is_sorted(v0.begin(), v0.end(), cmp_fn_less) == true);

        selection_sort(v0, cmp_fn_greater);
    ...
    SECTION("1 Elements") {
        ...
        selection_sort(v1, cmp_fn_less);
        REQUIRE(std::is_sorted(v1.begin(), v1.end(), cmp_fn_less) == true);

        selection_sort(v1, cmp_fn_greater);
    ...
    SECTION("5 Elements") {
        ...
        selection_sort(v5, cmp_fn_less);
        REQUIRE(std::is_sorted(v5.begin(), v5.end(), cmp_fn_less) == true);

        selection_sort(v5, cmp_fn_greater);
    ...
    SECTION("10 Elements") {
        ...
        selection_sort(v10, cmp_fn_less);
        REQUIRE(std::is_sorted(v10.begin(), v10.end(), cmp_fn_less) == true);

        selection_sort(v10, cmp_fn_greater);
    ...
    SECTION("100 Elements") {
        ...
        selection_sort(v100, cmp_fn_less);
        REQUIRE(std::is_sorted(v100.begin(), v100.end(), cmp_fn_less) == true);

        selection_sort(v100, cmp_fn_greater);
